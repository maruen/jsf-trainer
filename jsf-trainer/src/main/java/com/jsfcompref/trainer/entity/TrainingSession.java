...
public class TrainingSession extends AbstractEntity implements Serializable {
	...
	public boolean equals(Object obj) {
		...
		if (this.workoutDate != other.workoutDate
				&& (this.workoutDate == null || !this.workoutDate
						.equals(other.workoutDate))) {
			return false;
		}
		if ((this.workoutDescription == null) ? (other.workoutDescription != null)
				: !this.workoutDescription.equals(other.workoutDescription)) {
			return false;
		}
		if (this.completed != other.completed) {
			return false;
		}
		if ((this.personalNotes == null) ? (other.personalNotes != null)
				: !this.personalNotes.equals(other.personalNotes)) {
			return false;
		}
		if ((this.TrainerNotes == null) ? (other.TrainerNotes != null)
				: !this.TrainerNotes.equals(other.TrainerNotes)) {
			return false;
		}
		if (this.getEventId() != other.getEventId()
				&& (this.getEventId() == null || !this.eventId
	...
	public int hashCode() {
		int hash = 7;
		hash = 17 * hash
				+ (this.workoutDate != null ? this.workoutDate.hashCode() : 0);
		hash = 17
				* hash
				+ (this.workoutDescription != null ? this.workoutDescription
						.hashCode() : 0);
		hash = 17 * hash + (this.completed ? 1 : 0);
		hash = 17
				* hash
				+ (this.personalNotes != null ? this.personalNotes.hashCode()
						: 0);
		hash = 17
				* hash
				+ (this.TrainerNotes != null ? this.TrainerNotes.hashCode() : 0);
		hash = 17
				* hash
				+ (this.getEventId() != null ? this.getEventId().hashCode() : 0);
		return hash;
	}
	...
	public void setTrainerNotes(String trainerNotes) {
		...
		try {
			...
			Logger.getLogger(TrainingSession.class.getName()).log(Level.SEVERE,
					null, ex);
		}
	}
